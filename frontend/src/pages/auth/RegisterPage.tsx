...
export default function RegisterPage() {
  return (
    <div className="[&_.auth-mode-login]:hidden">
      <h1 className="sr-only">Register</h1>
      {/* Build a dedicated Register UI next */}
      <LoginPage />
    </div>
  );
}import { 
      ...
      <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_1fr]">
        ...
        <section className="hidden lg:block">
          ...
          <p className="mt-6 max-w-lg text-lg leading-8 text-muted-foreground">
            ...
            Upload, organize, search and chat with

            your documents using cutting-edge AI.
          ...
          <div className="mt-12 flex items-center gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                AES-256 encryption with secure AI
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    chatting with documents instantly.
